...
myStartupHook = do spawn "xmodmap /home/Ornyx/.Xmodmap"

-----------------------------------------------------------------------
-- Audio Keys

volumeKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList
...
-- Brightness Keys
{-
brightnessKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList
  [ ((0, xF86XK_MonBrightnessUp), spawn "xbacklight -inc 10")
  , ((0, xF86XK_MonBrightnessDown), spawn "xbacklight -dec 10")
  ]
-} --old brightness keys, combined with myAdditKeys


------------------------------------------------------------------------
--- AdditionalKeysP stuff
myAdditKeys :: [(String, X ())]
myAdditKeys =
  [ ("M-S-l", spawn "betterlockscreen -l") --i3lock script
